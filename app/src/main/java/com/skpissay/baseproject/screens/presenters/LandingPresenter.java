...
public class LandingPresenter extends BasePresenter {
    ...
    Observer<Response<ProductsAll>> mObserverProductsAll = new Observer<Response<ProductsAll>>() {
        @Override
        public void onCompleted() {
        ...
        @Override
        public void onNext(Response<ProductsAll> productsAllResponse) {
            mLandingView.onProductList(productsAllResponse);
        }
    };
    ...
    public void getProductList(String path,
                   String id,
                   String token){
        subscribe(mLandingView.getProductList(path, id, token), mObserverProductsAll);
    }
